...
class ClassRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        if ($this->routeIs('classes.store')) {
            return [
                'List_Classes.*.Name' => ['required', 'alpha', 'max:20', 'min:3'],
                'List_Classes.*.Name_class_en' => ['required', 'alpha', 'max:20', 'min:3'],
    ...
    public function messages()
    {
        if ($this->routeIs('classes.store')) {
            return [
                ...
                'Name.alpha' => 'The name is letters',
                ...
                'Name_class_en.alpha' => 'The name en is letters',
