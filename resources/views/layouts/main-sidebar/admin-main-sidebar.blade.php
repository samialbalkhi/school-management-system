...
<li>
    <a href="javascript:void(0);" data-toggle="collapse" data-target="#students-menu"><i
            class="fas fa-user-graduate"></i>{{ trans('StudentsTranslation.students') }}<div class="pull-right"><i
                class="ti-plus"></i></div>
        <div class="clearfix"></div>
    </a>
    <ul id="students-menu" class="collapse">
        <li>
            <a href="javascript:void(0);" data-toggle="collapse"
                data-target="#Student_information">{{ trans('StudentsTranslation.Student_information') }}<div
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse"
                data-target="#Students_upgrade">{{ trans('StudentsTranslation.promotestudents') }}<div
                    class="pull-right">
                    <i class="ti-plus"></i>
                </div>
                <div class="clearfix"></div>
            ...
            <ul id="Students_upgrade" class="collapse">
                <li> <a
                        href="{{ route('promotions.index') }}">{{ trans('StudentsTranslation.Addedanewpromotion') }}</a>
                </li>
                <li> <a
                        href="{{ route('promotions.create') }}">{{ trans('StudentsTranslation.Listofpromotions') }}</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse"
                data-target="#Graduate students">{{ trans('StudentsTranslation.graduatingstudents') }}<div
                    class="pull-right">
                    <i class="ti-plus"></i>
                </div>
                <div class="clearfix"></div>
            ...
            <ul id="Graduate students" class="collapse">
                <li> <a
                        href="{{ route('graduated.create') }}">{{ trans('StudentsTranslation.Addanewgraduation') }}</a>
                </li>
                <li> <a
                        href="{{ route('graduated.index') }}">{{ trans('StudentsTranslation.Listofgraduatestudents') }}</a>
                </li>
            </ul>
        </li>
    </ul>
...
<li>
    ...
    <ul id="Teachers-menu" class="collapse" data-parent="#sidebarnav">
        <li> <a href="{{ route('Teachers.index') }}">{{ trans('TeachersTranslation.list_teachers') }}</a> </li>
    </ul>
</li>
...
<li>
    ...
    <ul id="Parents-menu" class="collapse" data-parent="#sidebarnav">
        <li> <a href="{{ url('addparents') }}">{{ trans('ParentsTranslate.List_Parents') }}</a> </li>
    </ul>
</li>
...
<li>
    ...
    <ul id="Onlineclasses-icon" class="collapse" data-parent="#sidebarnav">
        <li> <a href="{{ route('classonline.index') }}">حصص اونلاين مع زوم</a> </li>
    </ul>
</li>
...
<!-- Settings-->
<li>
    <a href="{{ route('settings') }}"><i class="fas fa-cogs"></i><span
