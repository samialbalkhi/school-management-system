<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <!-- الاقسام-->
        <li>
            <a href="{{ route('tech_section') }}"><i class="fas fa-chalkboard"></i><span
        ...
        <li>
            ...
            <ul id="sections-menu1" class="collapse" data-parent="#sidebarnav">
                <li><a href="{{ route('reports') }}">تقرير الحضور والغياب</a></li>
                <li><a href="{{ route('reports') }}">تقرير الامتحانات</a></li>
            </ul>
        ...
        <!-- الملف الشخصي-->
        <li>
            <a href="{{ route('show.profile') }}"><i class="fas fa-id-card-alt"></i><span class="right-nav-text">الملف
                    الشخصي</span></a>
        </li>
