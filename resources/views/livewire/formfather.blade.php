...
<div class="col-xs-12">
    <div class="col-md-12">
        ...
        <div class="form-row">
            <div class="col">
                <label for="title">{{ trans('ParentsTranslate.Name_Father') }}</label>
            ...
            <div class="col">
                <label for="title">{{ trans('ParentsTranslate.Name_Father_en') }}</label>
        ...
        <div class="form-row">
            <div class="col-md-3">
                <label for="title">{{ trans('ParentsTranslate.Job_Father') }}</label>
            ...
            <div class="col-md-3">
                <label for="title">{{ trans('ParentsTranslate.Job_Father_en') }}</label>
            ...
            <div class="col">
                <label for="title">{{ trans('ParentsTranslate.National_ID_Father') }}</label>
            ...
            <div class="col">
                <label for="title">{{ trans('ParentsTranslate.Passport_ID_Father') }}</label>
            ...
            <div class="col">
                <label for="title">{{ trans('ParentsTranslate.Phone_Father') }}</label>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label for="inputCity">{{ trans('ParentsTranslate.Nationality_Father_id') }}</label>
            ...
            <div class="form-group col">
                <label for="inputState">{{ trans('ParentsTranslate.Blood_Type_Father_id') }}</label>
            ...
            <div class="form-group col">
                <label for="inputZip">{{ trans('ParentsTranslate.Religion_Father_id') }}</label>
        ...
        <div class="form-group">
            <label for="exampleFormControlTextarea1">{{ trans('ParentsTranslate.Address_Father') }}</label>
