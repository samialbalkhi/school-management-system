...
@section('page-header')
    <!-- breadcrumb -->
@section('PageTitle')
تعديل سند قبض : <label style="color: red">{{$receipt_student->students->name}}</label>
@stop
<!-- breadcrumb -->
@endsection
@section('content')
            ...
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <form action="{{route('receipt.update',$receipt_student->id)}}" method="post" autocomplete="off">
                                @method('PUT')
                                @csrf
                            @csrf
                            <div class="row">
