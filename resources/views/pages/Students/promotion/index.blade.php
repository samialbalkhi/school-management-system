    ...
    <div class="col-md-12 mb-30">
        <div class="card card-statistics h-100">
            <div class="card-body">
                ...
                <h6 style="color: red;font-family: Cairo">{{ trans('StudentsTranslation.oldschoolstage') }}</h6><br>
                ...
                <form method="post" action="{{ route('promotions.store') }}">
                    ...
                    <br>
                    <h6 style="color: red;font-family: Cairo">{{ trans('StudentsTranslation.Thenewprimarystage') }}
                    </h6><br>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="academic_year_new">{{ trans('StudentsTranslation.academic_year_new') }} : <span
                                        class="text-danger">*</span></label>
