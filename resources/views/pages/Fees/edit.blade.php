        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form action="{{route('fees.update',$fees->id)}}" method="post" autocomplete="off">
                        @method('PUT')
                        @csrf
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="Classroom_id">
                                    <option value="{{$fees->classroom_id}}">{{$fees->classrooms->name}}</option>
                                </select>
                            </div>
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-2" name="year">
                                    ...
                                    @for($year=$current_year; $year<=$current_year +1 ;$year++)
                                        <option value="{{ $year}}" {{$year == $fees->yeae ? 'selected' : ' '}}>{{ $year }}</option>
                                    @endfor
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="exampleFormControlTextarea1"
                                      rows="4">{{$fees->description}}</textarea>
                        </div>
                        <br>
