                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($ProcessingFees as $ProcessingFee)
                                            ...
                                            <td>{{$ProcessingFee->description}}</td>
                                                <td>
                                                    <a href="{{route('paymentStudent.edit',$ProcessingFee->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                        ...
                                        @include('pages.PaymentStudent.Delete')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
