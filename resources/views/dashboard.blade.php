                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mb-30">
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            ...
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fas fa-binoculars mr-1" aria-hidden="true"></i><a
                                    href="{{ route('addparents') }}" target="_blank"><span class="text-danger">عرض
                                        البيانات</span></a>
                            </p>
                        </div>
                    </div>
                                                ...
                                                <tbody>
                                                    @forelse($Student as $items)
                                                        <tr>
                                                            ...
                                                            <td>{{ $items->name }}</td>
                                                            <td>{{ $items->email }}</td>
                                                            <td>{{ $items->genders->name }}</td>
                                                            <td>{{ $items->gardes->name }}</td>
                                                            <td>{{ $items->classrooms->name }}</td>
                                                            <td>{{ $items->sections->name }}</td>
                                                            <td class="text-success">{{ $items->created_at }}</td>
                                                        @empty
                                    ...
                                    <div class="tab-pane fade" id="teachers" role="tabpanel"
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center"
                                                ...
                                                @forelse($Teachertake as $teacher)
                                                    <tbody>
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>{{ $teacher->name }}</td>
                                    ...
                                    <div class="tab-pane fade" id="fee_invoices" role="tabpanel"
                                        ...
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center"
                                                ...
                                                <tbody>
                                                    @forelse($Fees_invoice as $section)
                                                        <tr>
                                                            <td>{{ $loop->iteration }}</td>
                                                            <td>{{ $section->date }}</td>
